...
import com.doublesymmetry.trackplayer.kotlinaudio.notification.DefaultMediaDescriptionAdapter;
import com.doublesymmetry.trackplayer.kotlinaudio.notification.UtilRandom;
...
public class InternalNotificationManager {
  ...
  public static class Builder {
    ...
    public Builder(Context context, @IntRange(from = 1) int notificationId, String channelId) {
      ...
      smallIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_small_icon;
      playActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_play;
      pauseActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_pause;
      stopActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_stop;
      rewindActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_rewind;
      fastForwardActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_fastforward;
      previousActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_previous;
      nextActionIconResourceId = com.google.android.exoplayer2.ui.R.drawable.exo_notification_next;
    }
    ...
    public InternalNotificationManager build() {
      ...
      return new InternalNotificationManager(
          context,
          channelId,
          notificationId,
  ...
  protected InternalNotificationManager(
      Context context,
      String channelId,
      int notificationId,
      MediaDescriptionAdapter mediaDescriptionAdapter,
  ...
  private void startOrUpdateNotification(Player player, @Nullable Bitmap bitmap) {
    ...
    if (!isNotificationStarted) {
      UtilRandom.registerReceiverNotExported(context, notificationBroadcastReceiver, intentFilter);
    }
  ...
  private static Map<String, NotificationCompat.Action> createPlaybackActions(
    ...
    actions.put(
        ...
        new NotificationCompat.Action(
            stopActionIconResourceId,
            context.getString(com.google.android.exoplayer2.ui.R.string.exo_controls_stop_description),
  ...
  private class NotificationBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      Player player = InternalNotificationManager.this.player;
      if (player == null
