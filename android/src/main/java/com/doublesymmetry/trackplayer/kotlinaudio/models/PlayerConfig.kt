...
data class PlayerConfig(
     ...
     *
     * The sources can be: media buttons on headphones, Android Wear, Android Auto, Google
     * Assistant, media notification, etc.
     *
     * Setting this to true enables the use of [onPlayerActionTriggeredExternally]
     * [com.doublesymmetry.trackplayer.kotlinaudio.event.PlayerEventHolder.onPlayerActionTriggeredExternally]
     * events.
     *
     * **Example**:
     * ```
    ...
    /**
     * Whether audio focus should be managed automatically. See
